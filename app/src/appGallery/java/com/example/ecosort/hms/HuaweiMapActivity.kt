 ...
 * 
 * IMPORTANT: This is the HMS (Huawei Mobile Services) implementation.
 * For Google Maps implementation, see GoogleMapActivity.kt
 */
@AndroidEntryPoint
class HuaweiMapActivity : AppCompatActivity() , OnMarkerClickListener, OnBinItemClickListener {

    private val TAG = "HuaweiMapActivity"
